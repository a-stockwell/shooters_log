...
image::Shooter_Log-Domain.png[Shooters Log Domain Model,title="Shooters Log Domain Model"]

=== Services

image::Shooter_Log-Services.png[Shooters Log Services Model,title="Shooters Log Services Model"]
